...
export const SCHEMA_MIGRATE_MESSAGE =
  "The production database is missing tables or columns this app expects (often Contractor.loginToken, Customer.passwordHash, Invoice, or ContractorPayout). Apply Prisma migrations: npm run db:migrate with DATABASE_URL and DATABASE_URL_UNPOOLED.";
